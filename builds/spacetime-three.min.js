...
(function (global, factory) {
  ...
  for (let i = -14; i <= 14; i += 1) {
    ...
    zones$3[`${name}:30`] = { offset: zones$3[name].offset + dec, hem: 'n' };
  ...
  zones$3['Etc/GMT-0:30'] = { offset: 0.5, hem: 'n' };
  zones$3['Etc/GMT+0:30'] = { offset: -0.5, hem: 'n' };
  var zones$4 = zones$3;
  ...
  const parse = function (input, tz, world) {
    ...
    if (!tz) {
      tz = parseTz$2(cal.offset, world) || world.methods.fallbackTz(world);
    }
  ...
  const fromCal$1 = function (s, cal) {
  ...
  var dayMethods = {
    ...
    day: function (input, fwd) {
      ...
      if (input !== undefined) {
        ...
        let obj = tickBy(cal, diff, 'date', world);//untested
  ...
  const mapping = {
    ...
    MMM: (s, cal) => fmts['month-short'](s, cal),
