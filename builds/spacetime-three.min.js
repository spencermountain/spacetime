...
(function (global, factory) {
  ...
  const units$2 = ['year', 'month', 'date', 'hour', 'minute', 'second', 'millisecond'];
  ...
  const progress = function (s, unit) {
    return {}
  };
  ...
  let methods$1 = Object.assign({}, units$1, fmt, add, compare, { debug: debug$1, now, progress: progress$1 });
