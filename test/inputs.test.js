...
test('inputs', (t) => {
  ...
  t.equal(a.isSame(b, 'day'), 'b-is-equal');
  t.equal(a.isSame(c, 'day'), 'c-is-equal');
  t.equal(a.isSame(d, 'day'), 'd-is-equal');
  t.equal(a.isSame(e, 'day'), 'e-is-equal');
  t.equal(a.isSame(f, 'day'), 'f-is-equal');
  t.end();
});
