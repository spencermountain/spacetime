...
test('add', (t) => {
  let s = spacetime('January 1, 2017 1:20:05', 'Etc/GMT-4')
  //initial state
  ...
  t.equal(s.month(), 1, 'movehour-.month()')
  ...
  s = spacetime('January 1, 2017 1:20:05', 'Etc/GMT-4')
  // s.add(1, 'quarter');
...
test('hour-tricky', (t) => {
  let s = spacetime('January 1, 2017 13:20:00', 'Etc/GMT-9')
...
test('year-tricky', (t) => {
  let s = spacetime(1451667600000, 'Etc/GMT-4') //jan 1 2016 (leap year)
