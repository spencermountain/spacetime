(function (global, factory) {
  ...
  var fixedHolidays = {
    ...
    'day of the dead': [oct$1, 31],
    // Ranged holiday [nov, 2],
    'dia de muertos': [oct$1, 31],
    // Ranged holiday [nov, 2],
  ...
  var jan = 'january';
  var feb = 'february';
  var mar = 'march'; // const apr = 'april'

  var may = 'may';
  var jun = 'june'; // const jul = 'july'
  // const aug = 'august'

  var sep = 'september';
  var oct = 'october';
  var nov = 'november'; // const dec = 'december'
  ...
  var holidays = {
    ...
    'commonwealth day': [2, mon, mar],
    //[second monday in march],
    'mothers day': [2, sun, may],
    //[second Sunday in May],
    'fathers day': [3, sun, jun],
    //[third Sunday in June],
    'labor day': [1, mon, sep],
    //[first monday in september],
    'columbus day': [2, mon, oct],
    //[second monday in october],
    'canadian thanksgiving': [2, mon, oct],
    //[second monday in october],
    thanksgiving: [4, thurs, nov],
